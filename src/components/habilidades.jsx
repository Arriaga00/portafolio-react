  ...
  return (
    <>
        ...
        <div className="flex space-x-4 pl-4 p-x-5 flex-wrap gap-y-3">
            ...
            <div className="flex items-center bg-[#f5f5f5] text-[#414855] border-2 border-[#ce6549] text-sm font-bold px-4 py-2 rounded-full"> Git</div>
            <div className="flex items-center bg-[#f5f5f5] text-[#414855] border-2 border-[#000000] text-sm font-bold px-4 py-2 rounded-full"> Github</div>
            <div className="flex items-center bg-[#f5f5f5] text-[#414855] border-2 border-[#] text-sm font-bold px-4 py-2 rounded-full"> Aprendizaje constante</div>
            <div className="flex items-center bg-[#f5f5f5] text-[#414855] border-2 border-[#d17448] text-sm font-bold px-4 py-2 rounded-full"> HTML</div>
            <div className="flex items-center bg-[#f5f5f5] text-[#414855] border-2 border-[#] text-sm font-bold px-4 py-2 rounded-full"> Tecnologia de la informacion</div>
            ...
            <div className="flex items-center bg-[#f5f5f5] text-[#414855] border-2 border-[#] text-sm font-bold px-4 py-2 rounded-full"> Diseño web</div>
            <div className="flex items-center bg-[#f5f5f5] text-[#414855] border-2 border-[#] text-sm font-bold px-4 py-2 rounded-full"> Diseño web</div>
            <div className="flex items-center bg-[#f5f5f5] text-[#414855] border-2 border-[#c25f94] text-sm font-bold px-4 py-2 rounded-full"> Sass</div>
        </div>

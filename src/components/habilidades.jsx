import Separador from "./separador"
 ...
 const Habilidades = () => {
  ...
  const estilo = 'flex items-center bg-[#f5f5f5] dark:bg-[#131825] dark:text-[#eaebf1] dark:border-[#da7066] text-[#414855] border border-blue-200 text-sm font-semibold px-4 py-2 rounded-full'
  return (
    <>

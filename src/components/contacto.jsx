    ...
    <>
      ...
      <section className="text-gray-600 body-font relative">
        <div className="container px-5 py-14 mx-auto flex sm:flex-nowrap flex-wrap">
          <div className="lg:w-2/3 md:w-1/2 border-2 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative dark:border-[#26304b]">
            ...
            <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md dark:bg-[#131825]">
              <div className="lg:w-1/2 px-6">
                <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs dark:text-[#eaebf1]">Direccion</h2>
                <p className="mt-1 dark:text-[#eaebf1]">Calle 126 a sur #50-45 Caldas, Antioquia, Colombia</p>
              </div>
              <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs dark:text-[#eaebf1]">EMAIL</h2>
                <a className="text-indigo-500 leading-relaxed">andresfelipearriagam@outlook.com</a>
                <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4 dark:text-[#eaebf1]">CELULAR</h2>
                <p className="leading-relaxed dark:text-[#eaebf1]">300-721-3329</p>
              </div>
            </div>
          </div>

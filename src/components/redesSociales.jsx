...
const btn = 'bg-gray-200 inline-flex py-3 px-4 rounded-lg items-center  md:ml-0 ml-4 md:mt-4 mt-0 lg:mt-0 hover:bg-gray-300 focus:outline-none transition ease-in-out duration-300 w-36 m-0'
